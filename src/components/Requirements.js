...
<div className="k-container clearfix k-padding-big quattorcolor-bg">
    ...
    <div className="[ zeb-10 zeb-m-12 ] flexxer align-center wrapit">
        <div className="[ zeb-6 zeb-m-12 ]  k-padding-small">
            ...
            <div className="k-panel ">
                <h2 className='unuscolor-txt'>
                    Todo depende de ti, para tu aprobación sólo necesitas descargar la app y asegurarte que tus
                    documentos estén claros y vigentes al momento de subirlos.
                </h2>
            </div>
        </div>
